import { Body, Controller, Post, Headers, ValidationPipe, UsePipes, HttpCode } from "@nestjs/common";
...
export class InternalServicesController
{
    ...
    {
        body = await MetodosGenericos.getDatosSolicutd('VALIDAR_CREDENCIALES', headers, body);
        return await this.serviceLocator.resolve('ValidarCredencialesHandler').handle(body);
    }
